...
key_list = ['rotations0','ESRotations0','ESRotations1','ESRotations2']
descriptions = ['rotations', 'rotations w/ 150 patience','rotations w/ 200 patience', 'rotations w/ 200 patience & full epochs']
