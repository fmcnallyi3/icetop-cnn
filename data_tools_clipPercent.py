...
def dataPrep(x, y, q=None, t=None, normed=False, reco=None, cosz=False, rot=None, t_shift=False, t_clip=0):
             #recocut=False):
    ...
    #Time NORMALIZATION - FEATURE CLIPPING (MAX TIME)        
    if t_clip<=100.0:
        clip_percent = 1 - (t_clip*0.01)
        clip_value= clip_percent* 46412
        out_array[...,2:] = np.clip(out_array[...,2:],0, clip_value)
