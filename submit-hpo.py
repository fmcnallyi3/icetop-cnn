...
print(venv_path)
print(ICETOP_CNN_DIR+'.venv')
print(os.getenv('VIRTUAL_ENV'))
assert ICETOP_CNN_DIR+'/.venv' == venv_path, ERROR_ENVIRONMENT_NOT_ACTIVATED
...
def main(args):
    ...
    # Create model folder
    #print( os.path.join(ICETOP_CNN_DATA_DIR, 'models', args.model_name) )
    #THIS IS STILL A PROBLEMATIC LINE!!!!
    ...
    lines = [
        ...
        #Pelican Authorization
        f'+oauth_handle = "{JOBNAME}"', #Gotta fix this
        '+oauth_file_transform = True',
        'use_oauth_services = pelican',
        f'pelican_oauth_permissions_{JOBNAME} = storage.read:/data/user/fmcnally/icetop-cnn', #Also this
        #Get paths to:
        # /data/user/jstowers/icetop-cnn
        # /home/user/jstowers/icetop-cnn
        # /scratch/jstowers/icetop-cnn
        f'storage.modify:
